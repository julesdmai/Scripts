...
The JPEG file would be used for initial viewing, culling, and initial sharing.
The RAW file would be used for maximum image fidelity allowing for deeper edits - portfolio, deliverables, client work.

When a photographer reviews their images, they will typically look through the JPEG files which are lighter weight.
However, when the user deletes a JPEG file (culling the photo), the matching pair RAW file still remains.
